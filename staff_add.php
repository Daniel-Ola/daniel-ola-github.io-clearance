                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 col-md-offset-2">
                                <div class="card-box">
                                    <h4 class="m-b-20 text-center">Add New Staffs</h4>
                                    <div id='result'></div>
                                        <form class="form-horizontal" role="form" action="admin/actionmanager.php" id="staff_add">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="firstname">First name</label>
                                                <div class="col-md-10" id="firstnamediv">
                                                    <input type="text" name="firstname" id="firstname" class="form-control error" value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12">
                                                <button class="btn btn-lg btn-success" type="submit" id="staff_addbutton">Add</button>
