...
//get the lists of the students with cleared clearance in the database with clearance status of 0
$studentclearance_cleared = $dataRead->studentsclearance_cleared($mycon, '0');
                ...
                <div id="page-right-content">
                                ...
                                <div class="table-responsive m-b-20">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href='clearance_status.php?user=<?php echo $row["member_id"]; ?>&type=<?php echo $row["type"] ?>'><button class='btn btn-primary' > <i class='fa fa-eye'></i> View More</button></a></td>
                                        </tr>
                                        <?php 
                                            }
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>Full Name: <?php echo $members_get['firstname']. " ". $row['lastname']; ?></p>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            ...
                            <?php
                                ...
                                $clearance_done = $dataRead->clearance_done_by_students($mycon, $row['member_id'], '0');
                            ?>
                            <ul>
                            <?php
                                                    if ($clearance_done == null)
                        ...
                        <div class="col-md-4">
                            ...
                            <?php
                                //get the list of the clearance awaiting approval by the user
                                $clearance_done = $dataRead->clearance_done_by_students($mycon, $row['member_id'], '4');
                            ?>
                            <ul>
                            <?php
                                                    if ($clearance_done == null)
