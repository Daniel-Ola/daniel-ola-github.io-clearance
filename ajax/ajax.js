...
$('#registerform').on("submit", function(event){
    $('#createaccountbutton').html(" Submiting...");
    $('.error').removeClass("has-error");
...
$('#bankaccountupdate').on("click", function(event){
    $('#bankaccountupdate').html(" Updating...");
...
//SUBMIT THE REGISTERATION FORM
$('#priority_add').on("submit", function(event){
    $('#priority_addbutton').html(" Adding...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     /* get some values from elements on the page: */
         var $form = $(this),
            ...
            deadlinedate = $form.find('input[name="deadlinedate"]').val(),
            deadlinetime = $form.find('input[name="deadlinetime"]').val(),
            url = $form.attr('action');
     ...
     if (department == '')
     {
        ...
        msg += '<br> Please select a specific department';
        count += 1;
     }
     if (instruction == '')
     {
        $('#instructiondiv').addClass("has-error")
        msg += '<br> Add the instruction needed for the clearance';
        count += 1;
     }

     if (deadlinedate == '')
     {
        $('#deadlinedatediv').addClass("has-error")
        msg += '<br> Set deadline date';
        count += 1;
     }

     if (deadlinetime == '')
     {
        $('#deadlinetimediv').addClass("has-error")
        msg += '<br> Set deadline time';
        count += 1;
     }
     ...
     if (msg != '')
     {
        if (count == 1)
        {
            $('#result').html("<div class='alert alert-danger alert-dismissable'>" + 
                                                "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>" +
                                                "<i class='fa fa-warning'></i> ** "+count+" error was found, please double check your information.<br>" + msg +
                                            "</div>");
        }
        else {
            $('#result').html("<div class='alert alert-danger alert-dismissable'>" + 
                                                "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>" +
                                                "<i class='fa fa-warning'></i> ** "+count+" errors were found, please double check your information.<br>" + msg +
                                            "</div>");
        }
        $('#priority_addbutton').html("Add again");
        return;
     }
...
//SUBMIT THE REGISTERATION FORM
$('#priority_update').on("submit", function(event){
    $('#priority_updatebutton').html(" Updating...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     /* get some values from elements on the page: */
         var $form = $(this),
            ...
            deadlinedate = $form.find('input[name="deadlinedate"]').val(),
            deadlinetime = $form.find('input[name="deadlinetime"]').val(),
            priority_id = $form.find('input[id="priority_id"]').val(),
            url = $form.attr('action');
     ...
     if (msg != '')
     {
        ...
        $('#priority_updatebutton').html("Add again");
        return;
     }
...
$("#staff_add").on("submit", function(event){
    $('#staff_addbutton').html(" Adding...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     if (msg != '')
     {
        ...
        $('#staff_addbutton').html("Add again");
        return;
     }
...
$("#students_add").on("submit", function(event){
    $('#students_addbutton').html(" Adding...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     {
        $('#usernamediv').addClass("has-error")
        msg += '<br> Matric number is required';
        count += 1;
     }
     if (firstname == '')
     {
     ...
     if (status == '')
     {
        ...
        msg += '<br> Select the student status to proceed clearance';
        count += 1;
     }
     ...
     if (msg != '')
     {
        ...
        $('#students_addbutton').html("Add again");
        return;
     }
...
$('#departments_add').on("submit", function(event){
    $('#departments_addbutton').html(" Adding...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     /* get some values from elements on the page: */
         var $form = $(this),
            ...
            head = $form.find('select[name="head"]').val(),
            url = $form.attr('action');
     ...
     if (department == '')
     {
            $('#result').html("<div class='alert alert-danger alert-dismissable'>" + 
                                                "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>" +
                                                "<i class='fa fa-warning'></i> ** The name of the department is required..." +
                                            "</div>");
        
        $('#departments_addbutton').html("Add again");
        return;
     }
      ...
      if (head == '')
     {
            $('#result').html("<div class='alert alert-danger alert-dismissable'>" + 
                                                "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>" +
                                                "<i class='fa fa-warning'></i> ** Set the head of the deparment..." +
                                            "</div>");
...
$('#departments_update').on("submit", function(event){
    $('#departments_updatebutton').html(" Updating...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     /* get some values from elements on the page: */
         var $form = $(this),
            ...
            description = $form.find('textarea[name="description"]').val(),
            head = $form.find('select[name="head"]').val(),
            department_id = $form.find('input[id="department_id"]').val(),
            url = $form.attr('action');
     ...
     if (department == '')
     {
        ...
        $('#departments_updatebutton').html("Add again");
        return;
     }
...
$('#staff_update').on("submit", function(event){
    $('#staff_updatebutton').html(" Updating...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     /* get some values from elements on the page: */
         var $form = $(this),
            ...
            bio = $form.find('textarea[name="bio"]').val(),
            department = $form.find('select[name="department"]').val(),
            member_id = $form.find('input[id="member_id"]').val(),
            url = $form.attr('action');
     ...
     if (msg != '')
     {
        ...
        $('#staff_updatebutton').html("Add again");
        return;
     }
...
$('#students_update').on("submit", function(event){
    $('#students_updatebutton').html("Updating...");
    $('.error').removeClass("has-error");
    ...
    event.preventDefault();
     ...
     {
        $('#statusdiv').addClass("has-error")
        msg += '<br> Select the status of student for clearance.';
        count += 1;
     }
     ...
     if (msg != '')
     {
        ...
        $('#students_updatebutton').html("Add again");
        return;
     }
...
{
    $('#emailverifybutton').html(" Verifying...");
    $('.error').removeClass("has-error");
...
function extend(matching_id) {
    $('#extendbutton'+matching_id).html(" Extending...");
...
function falsePayment(matching_id) {
    $('#falsepaymentbutton'+matching_id).html(" Flaging...");
    $('#extend').removeClass('has-error');
    var matching_id = matching_id,
        password = $('#extendpassword'+matching_id).val();
        url = 'admin/actionmanager.php';
...
$('#sortmatchingbutton').on("click", function(event){
    $('#sortmatchingbutton').html(" Sorting...");
    event.preventDefault();
...
$('#updateBankAccounts').on("submit", function(event){
    $('#bankaccountupdatebutton').html(" Updating...");
    event.preventDefault();
...
{
    $('#recoververifybutton').html(" Verifying...");
    $('.error').removeClass("has-error");
...
function testimony(donation_id) {
    $('#testimonybutton'+donation_id).html(" Saving...");
...
$('#newtestimonyform').on('submit', function(event){
    $('#newssave').html(" Saving...");
    $('.error').removeClass("has-error");
    ...
    /* get some values from elements on the page: */
         var $form = $(this),
            ...
            testimony = $form.find('textarea[name="testimony"]').val(),
     ...
     if (testimony == '')
     {
        $('#testimonydiv').addClass("has-error")
        msg += '<br>Testimony is required';
        count += 1;
     }
     if (amount == '')
     {
        $('#amountdiv').addClass("has-error")
        msg += '<br>Amount is required';
        count += 1;
     }
     if (date == '')
     {
        $('#datediv').addClass("has-error")
        msg += '<br>Date is required';
        count += 1;
     }
     if (msg != '')
     {
        if (count == 1)
        {
            $('#result').html("<div class='alert alert-danger alert-dismissable'>" + 
                                                "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>" +
                                                "<i class='fa fa-warning'></i> ** "+count+" error was found, please double check your information." + msg +
                                            "</div>");
        }
        else {
            $('#result').html("<div class='alert alert-danger alert-dismissable'>" + 
                                                "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>" +
                                                "<i class='fa fa-warning'></i> ** "+count+" errors were found, please double check your information." + msg +
                                            "</div>");
        }
        $('#newssave').html("Save");
        return;
    ...
    var posting = $.post(url, {
        ...
        amount: amount,
        date: date,
        command: "testimony_add_admin" 
    });
    
    /* Put the results in a div */
    posting.done(function(data) {
        $("#result").html(data);
        $('#newssave').html("Save changes");
...
//add new testimony form
$('#edittestimonyform').on('submit', function(event){
    $('#newsupdate').html(" Updating...");
    $('.error').removeClass("has-error");
    ...
    /* get some values from elements on the page: */
         var $form = $(this),
            admintestimony_id = $form.find('input[name="admintestimony_id"]').val(),
            name = $form.find('input[name="name"]').val(),
            testimony = $form.find('textarea[name="testimony"]').val(),
            amount = $form.find('input[name="amount"]').val(),
            date = $form.find('input[name="date"]').val(),
    ...
    var posting = $.post(url, {
        ...
        amount: amount,
        date: date,
        admintestimony_id: admintestimony_id,
        command: "testimony_update_admin" 
    });
