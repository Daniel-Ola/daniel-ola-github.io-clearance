...
$students_getall = $dataRead->clearance_status_done_by_students_department($mycon, $staffdetails['department_id']); //0 signifies students
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($students_getall as $row) {
                                                ...
                                                $clearance_done = $dataRead->clearance_done_by_students_departments($mycon, $row['member_id'], '0', $staffdetails['department_id']);
                                            ?>
                                        <tr>
                                            ...
                                            <td><a href='clearance_all.php?user=<?php echo $row["member_id"]; ?>&type=0'><button class='btn btn-primary' > <i class='fa fa-eye'></i> View More</button></a></td>
                                        </tr>
                                        <?php 
                                            }
                        ...
                        <div class="col-md-4">
                            ...
                            <?php
                                                ...
                                                <?php 
                                                    ...
                                                    {
                                                ?>
                                                    <li><?php echo $clear['name']; ?> - <a href="uploads/<?php echo $clear['clearance_status_id'] ?>.jpg" style="text-decoration: : underline;"> View Documents </a></li>
                         ...
                         <div class="col-md-4">
                            ...
                            <?php
                                                ...
                                                ?>
                                                    <li><?php echo $clear['name']; ?> - <a href="uploads/<?php echo $clear['clearance_status_id'] ?>.jpg" target="_blank" style="text-decoration: : underline;"> View Documents </a> </li>
                                                    <p>Details: <?php echo $clear['addinfo'] ?> </p>
