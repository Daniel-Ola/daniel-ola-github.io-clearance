...
$students_getall = $dataRead->clearance_status_done_by_students($mycon, $staffdetails['department_id'], '0'); //0 signifies students
        ...
        <div id="page-wrapper">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                       <div class="row">
                            <div class="col-md-12">
                                <h4 class="m-t-0 header-title">Clearance status Approval</h4>

                                <div class="table-responsive m-b-20">
                                    <p class="text-muted font-13 m-b-30">
                                        Status of your clearance approval for each students
                                    </p>
