                                            ...
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <form class="form-horizontal" method="post" role="form" action="admin/actionmanager.php" id="clearance_add<?php echo $count ?>" target="clearanceframe<?php echo $count ?>" enctype="multipart/form-data">
                                                        <iframe name="clearanceframe<?php echo $count ?>" id="clearanceframe<?php echo $count ?>" width="200px" height="70px" frameborder="0"></iframe> <hr style="border: 1px solid grey ;opacity: 0.5 ; display: none;" class="firstdoc"><span class="badge firstdoc" style="display: none;">1</span>
                                                        <div id="doc_timeline">
                                                        ...
                                                        <div id="appendmore" class="appendmore" style="display: none;">
                                                            <hr style="border: 1px solid grey ;opacity: 0.5 ;"><span class="badge"></span>
                                                            <div class="form-group">
                                                                <label class="col-md-3 control-label" for="document<?php echo $count ?>">Upload documents</label>
                                                                <div class="col-md-9">
                                                                    <input type="file" name="document" id="document<?php echo $count ?>" class="form-control">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-9 pull-right">
                                                                    <button type="button" class="btn btn-xs btn-danger pull-right"><i class="fa fa-remove"></i> Remove</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br>
                                                            <br>
                                                            <button class="btn btn-xs btn-primary appendbtn" onclick="appendMore()" type="button" id="clearance_addmorebutton<?php echo $count ?>">Attach More</button>
                                                            <br>
                                                            <br>
