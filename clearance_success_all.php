                                ...
                                <div class="table-responsive m-b-20">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href='departments_edit.php?code=<?php echo $row["department_id"]; ?>'><button class='btn btn-primary' > <i class='fa fa-edit'></i> Edit </button></a> <a href='javascript:void(0);'><button class='btn btn-danger' onclick='location.href=departments_view.php?code<?php echo $row["department_id"] ?>"'></i> Delete  </button></a></td>
                                        </tr>
                                        <?php 
                                            }
