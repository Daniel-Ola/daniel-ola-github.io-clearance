                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-offset-2">
                                <div class="card-box">
                                    ...
                                    <div id='result'></div>
                                        <form class="form-horizontal" role="form" action="admin/actionmanager.php" id="staff_update">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10"  id="emaildiv">
                                                    <input type="email" name="email" id="email" class="form-control" value="<?php echo $members_get['email'] ?>"  readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10" id="departmentdiv">
                                                    <select name="department" class="form-control error" id="department">
                                                        <option value="<?php echo $members_get['department_id'] ?>"> <?php echo $members_get['name'] ?> </option>
                                                        <?php

                                                            foreach ($dapartments_get as $row) {
                                                                if ($members_get['name'] != $row['name'])
                                                                {
                                                        ?>
                                            ...
                                            <div class="col-xs-12">
                                                <button class="btn btn-lg btn-success" type="submit" id="staff_updatebutton">Update</button>
